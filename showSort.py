from showPackages import grammarCheck, folderBalance, showOptions, additionalShowInfo, likeToAdd, websiteListScraper
from showPackages import similarStrings
import os
import searchtools
...
# with open(bookmarkedShows,'r') as t:
#     bookmarklist = [line.strip() for line in t]

# bookmarklist.sort()

#This is the list that new shows will be stored in


#Just a line to let the user know the text file and folder path have been loaded
# print "Loading database of %d shows..." %(len(showList)-2)
newShows = []
while True:
